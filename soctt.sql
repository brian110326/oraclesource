...
-- 열이름(컬럼명) : ex) USERNAME => USER_NAME : snake case
...
INSERT INTO TBL_NOTNULL
VALUES('TEST_ID1', 'TEST_PWD1', NULL);
...
UPDATE TBL_NOTNULL
SET TEL = '010-2367-8728'
WHERE LOGIN_ID = 'TEST_ID1';
...
VALUES('TEST_ID1', 'TEST_PWD1', '010-1234-5678');

CREATE TABLE TBL_UNIQUE2(
	LOGIN_ID VARCHAR2(20) CONSTRAINTS TBL_UNQ2_LOGIN_ID UNIQUE,
	LOGIN_PWD VARCHAR2(20) CONSTRAINTS TBL_UNQ2_LOGIN_PWD NOT NULL,
	TEL VARCHAR2(20)	
) ;
...
VALUES('TEST_ID1', 'TEST_PWD1', '010-2367-8728') ;
...
INSERT INTO EMP_FK
VALUES(1000, 'HONG', 'CLERK', 7788, SYSDATE, 1200, NULL, 50) ;
...
CREATE TABLE EMP_FK2(
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) CONSTRAINT EMPFK2_DEPTNO_FK2 REFERENCES DEPT_FK(DEPTNO) ON DELETE CASCADE
) ;
...
CREATE TABLE EMP_FK3(
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) CONSTRAINT EMPFK3_DEPTNO_FK3 REFERENCES DEPT_FK(DEPTNO) ON DELETE SET NULL
) ;
...
INSERT INTO TBL_CHECK2
VALUES('TEST_ID1', '1234', 'DIAMOND', NULL) ;
...
VALUES('TEST_ID1', '4353', NULL) ;

INSERT INTO TBL_DEFAULT(LOGIN_ID, TEL)
VALUES('TEST_ID2', '010-2367-8728') ;
...
INCREMENT BY 10 START WITH 10 MAXVALUE 100 MINVALUE 0
NOCYCLE ;

INSERT INTO COMPANY 
VALUES(12345, '농심', '02-2323-3333', 'SEOUL', 'BRIAN');

INSERT INTO PRODUCT
VALUES(PRODUCT_SEQ.NEXTVAL, 12345, 'snack1', 33, 3000, SYSDATE, 50);
...
VALUES('uj05273', 'dkfksjdfjk', 'BRIAN', 25, 'STUDENT', 1, 1000);
